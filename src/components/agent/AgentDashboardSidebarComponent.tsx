...
import { AgentSidebarElement } from "./AgentSidebarElement";

const AgentDashboardSidebarComponent = () => {
  return (
    <aside className="w-64 bg-white shadow-lg pt-4 min-h-full h-auto">
      ...
      <nav>
        <ul className="border-t-2 pt-2 pl-2">
          {AgentSidebarElement.map((item, index) => (
...
export default AgentDashboardSidebarComponent;
